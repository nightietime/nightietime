...
To get an ESTA, all you have to do is simply plug in your details to the [DHS' ESTA application website](https://esta.cbp.dhs.gov/esta/). ESTAs cost 10 USD each application, and you'd most likely be accepted unless if you answer "yes" to the most questionable things they ask you. Once granted, you're all set - just use the passport that you have registered with the ESTA system to fly in to the United States.

In the event that your ESTA application is somehow denied, then I regret to inform you that you [need to apply for a tourism visa.](#visa)
