...
![US visa policy]({{"/images/Visa_policy_of_the_USA.png" | absolute_url}})
...
There are several foreigners that do not require a visa to enter - those who are eligible for an [ESTA](#esta) or those that live in [a select few countries](#financial). If you already have a visa that won't expire by the time you plan to enter the United States, [you can skip this part](#existing).
...
Of course, if you somehow get a job or admitted to university in the United States at any time as we approach to BronyCon, you'd apply for a different visa since your primary purpose is either work and study - and you can definitely travel freely in the US once admitted in. But that's an entirely different visa, and hence process, that I won't discuss here. You are welcome, however, to [skip ahead](#financial).
...
To apply for a visa, you have to [apply online at the State Department's website](https://travel.state.gov/content/travel/en/us-visas/tourism-visit/visitor.html#overview) and disclose all the information that is required on the application form. 
...
You must then go to the US embassy or consulate at the day you selected with all the documents you used to apply for the visa. You will then surrender them past security, get your biometrics taken, and attend an interview. The interview is basically a chat between you and a consular officer that will be the one who accepts or denies your application. Only speak when questioned, and reply with what is necessary and try not to waffle too far. Stay truthful to your intents and documents and do not lie. You will be informed if you are approved or denied on the spot. If you are approved, they'll tell you when you can pick up your passport and documents. If that happens, congratulations! [You can go down to the rest of the article now.](#financial)
...
All of the information I postulate here is peppered with my knowledge and advice on how you should prepare a visa application. The actual verbatim is [of course at the State Department's website](https://travel.state.gov/content/travel/en/us-visas/tourism-visit/visitor.html#overview) 
...
![]({{"/images/damning_condition.png" | absolute_url}})
...
### <a name="esta"></a> ESTA Eligible Countries
...
To get an ESTA, all you have to do is simply plug in your details to the [DHS' ESTA application website](https://esta.cbp.dhs.gov/esta/). ESTAs cost 14 USD each application, and you'd most likely be accepted unless if you answer "yes" to the most questionable things they ask you. Once granted, you're all set - just use the passport that you have registered with the ESTA system to fly in to the United States.
...
![]({{"/images/seapc_pricechart_sample.jpg" | absolute_url}})
...
![]({{"/images/ticketsample1.png" | absolute_url}})
...
![]({{"/images/ticketsample2.png" | absolute_url}})
...
I shall keep you posted on the next segment of this write-up. If you have any questions, just shout me out on [Twitter](https://twitter.com/NightieTime)!

## Further Reading
- [Wikipedia Summary of Nonimmigrant Visa Policies of the US](https://en.wikipedia.org/wiki/Visa_policy_of_the_United_States#Summary_of_visa_exemptions)
- [US State Department on the VWP](https://travel.state.gov/content/travel/en/us-visas/tourism-visit/visa-waiver-program.html)
- [US State Department on Visas](https://travel.state.gov/content/travel/en/us-visas/tourism-visit/visitor.html)